...
const breadcrumb = ref({ page:{id: 1, name: 'Configurações', url : "/configuracao"}, link:{id: 2, name: 'Canal', url : "/canal"}});
const form = useForm({
...
function updateChannel(){
    form.put(route("channel.update", props.channel.id));
};
                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    <form @submit.prevent="updateChannel">
                        <div class="border-b border-slate-900/10 pb-12">
                            <h2 class="text-base font-semibold leading-7 text-sky-900">Informações do Canal</h2>

...
let term = ref('');
const breadcrumb = ref({ page:{id: 1, name: 'Configurações', url : "/configuracao"}, link:{id: 1, name: 'Canal', url : "/canal"}});

watch(term, value =>{
    router.get('/canal', {term: value});
}); 
...
function destroy(id) {
    if (confirm("Are you sure you want to Delete")) {
        form.delete(route('canal.destroy', id));
    }
}
...
<template>
    <Head title="Canais de Atendimento" />  

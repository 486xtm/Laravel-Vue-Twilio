...
watch(filter,
    throttle( ()=>{
        ...
        let queryRoute = route('message.index', Object.keys(query).length ? query : {
            remember: 'forget',
        });
...
function destroy(id) {
    if (confirm("Are you sure you want to Delete")) {
        form.delete(route('message.destroy', id));
    }
}
            ...
            <div class="bg-white">
                ...
                >   
                    <div class="grid grid-cols-7 gap-3 px-4 py-6 text-slate-600 ">
                        <div class="">
                            <ButtonLink 
                                variant="primary"
                                class="block"
                                value="/messagem-rapida/criar">NOVO
                            </ButtonLink>
                        </div>
                        ...
                        <tbody>
                            ...
                            >
                                ...
                                <td>
                                    <ButtonLink
                                        variant="basic"
                                        :href="`/messagem-rapida/${message.id}/editar`"
                                        class="" >
                    ...
                    <div class="w-full bg-white justify-end py-5">
                        <Pagination :links="messages.links"></Pagination>
                    </div>
                </div>
            </div>
        </div><br><br>
